...
void CPropertiesWnd::InitPropList()
{
	...
	CMFCPropertyGridColorProperty* pColorProp = new CMFCPropertyGridColorProperty(_T("Color de ventana"), RGB(210, 192, 254), nullptr, _T("Especifica el color de ventana predeterminado"));
